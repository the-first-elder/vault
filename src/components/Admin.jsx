...
function Admin() {
	...
	const handleSubmit = async (e) => {
		e.preventDefault();
		if (!stakeholderaddress || !stakeholderPost || !period || !stakeholdertoken)
			return;
		try {
			const result = await addNewStakeholder(
				stakeholderaddress,
				stakeholderPost,
				period,
				stakeholdertoken
	...
	return (
		...
		>
			<div
				style={{
					background: `url('${background}') fixed no-repeat top/cover `,
				}}
			>
				<Navbar />
			</div>
			...
			<div className="pt-32 flex justify-between">
				<div className="container mx-auto mt-8">
					<div
						className="max-w-md mx-auto flex font-semibold text-2xl items-center bg-orange-400 uppercase
      justify-center shadow-md rounded px-8 py-6 text-white"
					>
						Add Organisation
					</div>
					<form
						className="max-w-md mx-auto bg-orange-200 shadow-md rounded px-8 py-6"
						onSubmit={orgSubmit}
					>
						<div className="mb-4">
							<label
				...
				<div className="container mx-auto mt-8">
					<div
						className="max-w-md mx-auto flex font-semibold text-2xl items-center bg-orange-300 uppercase
      justify-center shadow-md rounded px-8 py-6 text-white"
					>
						Add Stakeholder
					</div>
      ...
      justify-center shadow-md rounded px-8 py-6 text-white"
					...
					<form
						className="max-w-md mx-auto bg-orange-200 shadow-md rounded px-8 py-6"
						onSubmit={whiteListSubmit}
					>
						<div className="mb-4">
							<label
								className="flex text-gray-700 text-sm font-bold mb-2 items-center justify-center"
								htmlFor="name"
							>
								Address
							</label>
