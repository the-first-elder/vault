...
const Navbar = () => {
	...
	return (
		<header
			className={`flex justify-between p-5 top-0 z-0 shadow-md left-0 right-0 fixed bg-brown-200 `}
		>
			<div className="flex  ">
				<div className="flex space-x-2 justify-between items-center font-light text-2l text-white">
					<a href="/">
						<button
							className="flex space-x-2 hover:cursor-pointer bg-orange-500 px-5 py-2 hover:bg-orange-600
        rounded-md shadow-md items-center shadow-slate-500 hover:shadow-slate-800 leading-tight uppercase "
			...
			<div className="flex text-white ">
				<div className="flex space-x-8 justify-between items-center font-normal text-sm ">
					{connectedAccount ? (
						<div
							className="hover:cursor-pointer bg-orange-500 px-5 py-2 hover:bg-orange-600
